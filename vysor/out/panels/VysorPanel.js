...
exports.VysorPanel = void 0;
const vscode = __importStar(require("vscode"));
const contextResolver_1 = require("../utils/contextResolver");
...
class VysorPanel {
        ...
        this.panel.webview.onDidReceiveMessage(async (message) => {
            switch (message.type) {
                case 'query':
                    ...
                    const { input, context } = await (0, contextResolver_1.resolveContextFromInput)(text);
                    ...
                    output.show(true);
                    try {
                        const reply = await (0, llmClient_1.queryASICLLM)(input, context, this.messageHistory);
    ...
    static show(extensionUri) {
        ...
        if (VysorPanel.currentPanel) {
            ...
            const panel = vscode.window.createWebviewPanel('vysorChat', 'Vysor Chat', column, {
                enableScripts: true
            });
...
exports.VysorPanel = VysorPanel;
//# sourceMappingURL=VysorPanel.js.map